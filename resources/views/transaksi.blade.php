                        ...
                        <form action="{{route('tambah_transaksi')}}" method="POST">
                            ...
                            <div class="modal-body text-capitalize">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="nama_pelanggan" type="text" class="form-control" id="text">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="berat" type="text" class="form-control" id="text">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                            {{$t->pembayaran}}
                            <a type="button" class="btn btn-sm btn-success" href="{{route('hal-cetak',$t->id_transaksi)}}"><i class="fa-solid fa-money-bill"></i> Bayar</a>
                            @endif
                        </td>
                        <td>
                            <div class="d-flex justify-content-center gap-1 ">
                                            ...
                                            <form action="{{route('ubah_transaksi',$t->id_transaksi)}}" method="POST">
                                                ...
                                                <div class="modal-body text-capitalize">
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label for="text" class="col-sm-2 col-form-label">pembayaran</label>
                                                        <div class="col-sm-10">
                                                            <select name="pembayaran" value="{{$t->pembayaran}}" class="form-select" aria-label="Default select example">
                                                                <option value="Lunas" {{old('pembayaran', $t->pembayaran) == 'Lunas' ? 'selected' : ''}}>Lunas</option>
                                                                <option value="Belum Bayar" {{old('pembayaran', $t->pembayaran) == 'Belum Bayar' ? 'selected' : ''}}>Belum Bayar</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                ...
                                <button type="button" class="btn btn-sm btn-danger me-1" data-bs-toggle="modal" data-bs-target="#modalHapus{{$t->id_transaksi}}"><i class="fas fa-trash"></i> Hapus</button>
                                <!-- modal hapus -->
                                <div class="modal fade" id="modalHapus{{$t->id_transaksi}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <form action="{{route('hapus_transaksi',$t->id_transaksi)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <div class="modal-header">
